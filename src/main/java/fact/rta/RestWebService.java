 ...
 */
public class RestWebService implements Service {
    ...
    final private static Logger log = LoggerFactory.getLogger(RestWebService.class);
    ...
    public RestWebService() throws SQLException {
