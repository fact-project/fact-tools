...
public class TimeGradient implements Processor {
    ...
    @Parameter(required = false, description = "key to the x and y value of the cog of the shower", defaultValue = "shower:cog")
    ...
    public Data process (Data item) {
        ...
        Utils.mapContainsKeys(item, pixelSetKey, arrivalTimesKey,
