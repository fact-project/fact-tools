...
public class CleaningEvaluate implements Processor {
	...
	public Data process(Data input) {
		...
		input.put(outputKey+"_number_correct", correctIdentifiedShowerPixel.size());
		input.put(outputKey+"_wrong", wrongIdentifiedShowerPixel);
		input.put(outputKey+"_number_wrong", wrongIdentifiedShowerPixel.size());
		input.put(outputKey+"_not", notIdentifiedShowerPixel);
		input.put(outputKey+"_number_not", notIdentifiedShowerPixel.size());
