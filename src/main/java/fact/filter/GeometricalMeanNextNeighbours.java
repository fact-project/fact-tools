 ...
 *
 */
public class GeometricalMeanNextNeighbours implements Processor {
    static Logger log = LoggerFactory.getLogger(GeometricalMeanNextNeighbours.class);
