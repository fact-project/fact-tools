...
/**
 * Simple processor tho estimate the baseline amplitude with the average from
 * the slices of a given window Created by jbuss on 29.01.15.
 */
public class EstimateBaseline implements Processor {
    ...
    public Data process(Data input) {
        ...
        input.put(outputKey + ":range", mBslRange);
        input.put(outputKey + ":level", mBslLevel);
        return input;
    }
