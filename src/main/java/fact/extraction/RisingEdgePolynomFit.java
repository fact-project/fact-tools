...
public class RisingEdgePolynomFit implements Processor {
    ...
    /**
     * Calculates the position inflection point of the third order polynomial
     * with coefficient vector c f(x) = sum_{i=0}^3 c_i * x^i
     */
    ...
    /**
     * Calculates the derivative of a third order polynomial f(x) = sum_{i=0}^3
     * c_i * x^i
     * 
     * @param x
     *            position
