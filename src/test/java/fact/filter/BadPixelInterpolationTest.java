...
public class BadPixelInterpolationTest {
	...
	static Logger log = LoggerFactory.getLogger(BadPixelInterpolationTest.class);
	...
	public void testFilterLikeProcessors() {
		...
		try {
			...
			URL drsUrl =  BadPixelInterpolationTest.class.getResource("/test.drs.fits.gz");
			...
			URL dataUrl =  BadPixelInterpolationTest.class.getResource("/sample.fits.gz");
